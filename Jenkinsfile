pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/Rohaeb-2/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('alir2-225')   // <---- Change this to match your kubernetes cluster credentials
    }
